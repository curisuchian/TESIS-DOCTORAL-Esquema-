...
\begin{table}[H]
    \centering
    \caption{Evaluación por expertos de la precisión en la detección de sombras: Porcentaje de coincidencia ('Bueno', 'Regular', 'Malo') entre máscaras automáticas (generadas con ψBR, ψBG, ψGR y percentiles del 60º al 95º) y manuales"}
