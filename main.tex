...
\usepackage{dirtytalk}  %entre comillas
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Keywords command (castellano)
\providecommand{\claves}[1]
{
  \small	
...
\usepackage{listings}
\usepackage{longtable} %para tablas extensas incorporar saltos de pàgina
\usepackage{booktabs}
...
\begin{titlepage}
  ...
  \begin{multicols}{2}
Dr. Eduardo BATISTA, \\
Dr. Fernando BOTTERON, \\
Dr. Dra. María Genoveva GATTI, \\
...
\chapter{Trabajos futuros}      
    \input{Capitulos/trabajos.tex}
\appendix
\chapter{Lista de áreas naturales protegidas en la provincia de Misiones} \label{reservas}
\input{Tablas/lista_reservas}
\chapter{Algoritmo de procesamiento homomórfico}
\label{script_homo}
Código basado en Matlab/Octave
\lstinputlisting[
frame=single,
numbers=left,
style=Matlab-editor
...
\chapter{Imágenes procesadas por filtro homomórfico} \label{anexo_homo}
 \input{Figuras/img_hom_completo}
...
\input{Figuras/img_hom_completo}
 ...
 \input{Figuras/img_IIC_completo}
