...
\subsubsection{Detección automática de regiones sombreadas mediante recorrido de ventana}
...
%\color{cyan} %color de texto con 70-80 % o más de avance
\subsection{Análisis para conteo de copas de árboles según procesamiento morfológico (Wagner)}
