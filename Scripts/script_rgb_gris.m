...
% El siguiente código aplica el procesamiento homomórfico para implementar 
% un filtro a imágenes, para realizar la detección de sombras
clear all;
close all;
clc
...
hold on, plot(y,x,'.r'), title(['Máscara superpuesta a imagen original']);